...
function M.render(params)
    ...
    pcall(function()
        ...
        fonts.Label(string.format('HQ:      %d (%.1f%%)', stats.hq, stats.total > 0 and stats.hq / stats.total * 100 or 0))
        fonts.Label(string.format('NQ:      %d (%.1f%%)', stats.nq, stats.total > 0 and stats.nq / stats.total * 100 or 0))
